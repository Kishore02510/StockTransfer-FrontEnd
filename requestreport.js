...
function funIssuingDetails() {
    ...
    $.ajax({
        url: "http://localhost:8081/reqREport", // ✅ Update to your actual controller mapping
        type: "GET",
        data: {
            fromdate: fromDate  ,
            todate:toDate 
...
function funProdDetails() {
    ...
    $.ajax({
        url: "http://localhost:8081/reqProdReport", // ✅ Update to your actual controller mapping
        type: "GET",
        data: {
            fromdate: fromDate  ,
            todate:toDate 
            ...
            $.each(response, function(index, transfer) {
                tbody.append(
                    `<tr>
                        ...
                        <td>${transfer.receivedQuantity}</td>
